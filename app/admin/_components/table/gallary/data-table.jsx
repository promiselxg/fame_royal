...
export function GallaryTable({ columns, data, loading }) {
    ...
    <div className="rounded-md border my-5 p-5 mb-20">
      <div className="flex items-center  py-4 justify-between w-full flex-col md:flex-row space-y-3">
        <Input
          ...
          value={table.getColumn("gallary_title")?.getFilterValue() ?? ""}
          onChange={(event) =>
            table.getColumn("gallary_title")?.setFilterValue(event.target.value)
          }
