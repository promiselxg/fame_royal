...
export function ToursDataTable({ columns, data, loading }) {
    ...
    <div className="rounded-md border md:my-5 p-5 bg-white mb-20">
      <div className="flex items-center py-4 justify-between w-full flex-col md:flex-row space-y-3 ">
        <Input
          ...
          value={table?.getColumn("tour_name")?.getFilterValue() ?? ""}
          onChange={(event) =>
            table.getColumn("tour_name")?.setFilterValue(event.target.value)
          }
